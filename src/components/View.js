    ...
    return (
        <>
            <div className="h-screen bg-slate-900">
                <div className="h-[20vh] w-[70%]  mx-auto bg-slate-900   rounded-[24px] p-[2%] ">
                    <div className="flex flex-row justify-around items-start">
                        <div className="card bg-slate-800 w-[60%] rounded-[18px] contract-card">
                            <div className="card-body p-5 pt-0 flex flex-col justify-around items-center">
                                ...
                                <div className="flex justify-around items-center p-4 rounded-lg hover-to-shadow gap-2 file-review" >
                                    ...
                                    <span>
                                        <IoMdDownload className="download-icon p-3 hover-to-shadow" size={20} />
                                    </span>
                                    <span></span>

                                    <BsEyeFill className="see-icon p-3 hover-to-shadow" size={20} />
                                </div>
