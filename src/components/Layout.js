...
const IndexLayout = () => {
    ...
    return (
        <>
            <div className="h-[100vh] bg-slate-950 flex flex-col justify-center items-center main-container lg:py-10 ">
                <div className=" w-[75%] lg:w-[55%] flex justify-center items-center">
                ...
                <div className=" w-[95%] sm:w-[90%] lg:w-auto lg:px-10 xl:w-[65%] bg-slate-900 rounded-[24px]  parent-card flex flex-row justify-center items-center">
                    <Outlet />
                </div>
            </div >
            <Footer />
